...
var parseExcelAndPost = function(file) {
    ...
    reader.onload = function(e) {
        ...
        if(!workbook.Sheets["Paquetes"] || workbook.Sheets["Paquetes"].A1.v !== "Nombre del embalaje" || workbook.Sheets["Paquetes"].B1.v !== "Largo (cm)" || workbook.Sheets["Paquetes"].C1.v !== "Alto (cm)" || workbook.Sheets["Paquetes"].D1.v !== "Ancho (cm)") {
            new PNotify({
                title: 'Transporter',
            ...
            var excelJson = XLSX.utils.sheet_to_row_object_array(workbook.Sheets[workbook.SheetNames[0]], {
                header: ["nombre", "largo", "alto", "ancho"],
                range: 1
            });
