...
return array(
	...
	*/
	...
	"phone" => "El campo :attribute contiene un número de teléfono no válido",
	...
	"match"          => "El formato :attribute no es válido",
	"max"            => array(
	...
	"unique"         => "Este :attribute ya está siendo usado",
	"url"            => "El formato de :attribute no es válido",
	"timezone"       => "El campo :attribute debe ser una zona válida",
    "phone"          => "El campo teléfono no es un número válido",
    "dni"            => "El campo :attribute no es válido",
    'iban' => 'Por favor, introduzca un IBAN correcto',
