            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="alert alert-warning">
                        Vamos a proceder a realizar la verificación de tu tajeta. No realizaremos ningún cobro en la operación.
                    </div>

                    <form action="{{ route('perfil_verificar_tarjeta') }}" class="text-center">
...
<script type="text/javascript" defer>
    ...
    $(function() {
        ...
        $('.btn-eliminar-pago').on('click', function() {
            var route = '{!! route('perfil_metodo_pago') !!}';
