<div class="modal fade" tabindex="-1" role="dialog" id="crearPalabra" aria-labelledby="modalEditarLabel" aria-hidden="true">
    <div class="modal-dialog small-modal" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title col-md-6">Crear palabra</h3>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="{{ route('admin_crear_palabra') }}" method="post">
